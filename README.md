...
Interacting with Google Gemini via Python.
...
## Goals
My personal goal for this project is to gain more experience working with LLM's, like Gemini while also broadening my knowledge and skills of Python. This is why the prompt is configured to it's current state.
